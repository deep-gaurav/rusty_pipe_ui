...
final _get_port_Dart _get_port =
    _dl.lookupFunction<_get_port_C, _get_port_Dart>('get_port');
...
final _run_server_Dart _run_server =
    _dl.lookupFunction<_run_server_C, _run_server_Dart>('run_server');
